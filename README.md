...
```bash
# Usage: ./src/bash_scripts/save_map.sh [map_name]
./src/bash_scripts/save_map.sh my_lab_map
```
...
```bash
# Usage: ./src/bash_scripts/amcl.sh [map_name.yaml]
./src/bash_scripts/amcl.sh my_lab_map.yaml
```
...
```bash
# Usage: ./src/bash_scripts/navigation.sh [map_name.yaml]
./src/bash_scripts/navigation.sh my_lab_map.yaml
```
...
./src/bash_scripts/kill_process.sh
```
